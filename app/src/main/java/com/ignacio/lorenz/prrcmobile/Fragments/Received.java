...
public class Received extends Fragment {
    private String url = "http://192.168.1.16/PRRC-Dtracking/public/api/receive/";
    ...
    private List<HashMap<String, String>> received_docus = new ArrayList<>();
            ...
            public void onResponse(JSONArray response) {
                try{
                    for(int i = 0; i < response.length(); i++){
                        ...
                        received_docus.add(map);
                    }
                    adapter = new SimpleAdapter(getActivity(), received_docus, R.layout.fragment_received_list,
